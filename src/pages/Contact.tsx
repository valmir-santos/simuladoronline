    ...
    <div className="bg-white">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          {/* CONTACT FORM */}
          <div className="bg-white rounded-[4rem] shadow-2xl relative overflow-hidden border border-gray-100">
             <iframe 
               style={{ border: 'none', width: '100%', height: '800px' }} 
               src="https://chat.simulador.app.br/simulador-fale-conosco"
               title="Atendimento Fale Conosco"
             />
          </div>
